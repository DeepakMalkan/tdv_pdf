...
#    path = 'D:/Deepak/source/learn-python/tdv_pdf/test2.pdf'
    ...
    path6 = "C:/Users/Deepak.Malkan/OneDrive - Bentley Systems, Inc/Documents/iTwin Ventures/Bentley Biweekly/Bentley Biweekly 020123 vF.pdf"
    ...
    # tdv_pdf.process_phase1 (path6)

    # tdv_pdf.process_phase2 (path2)
    # tdv_pdf.process_phase2 (path6)
